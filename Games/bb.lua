...
local Window = RobloxRage.Utilities.UI:Window({
    Name = " I Miss The Rage — "..RobloxRage.Game,
    ...
    local SettingsTab = Window:Tab({Name = "Settings"}) do
        local MenuSection = SettingsTab:Section({Name = "Menu",Side = "Left"}) do
            ...
            MenuSection:Colorpicker({Name = "Color",Flag = "UI/Color",Value = {1,1,1,0,false},
        ...
        local BackgroundSection = SettingsTab:Section({Name = "Background",Side = "Right"}) do
            BackgroundSection:Dropdown({Name = "Image",Flag = "Background/Image",List = {
                {Name = "I Miss The Rage From CSGO",Mode = "Button",Value = true,Callback = function()
            ...
            BackgroundSection:Colorpicker({Name = "Color",Flag = "Background/Color",Value = {1,1,1,0,false},
        ...
        local CreditsSection = SettingsTab:Section({Name = "Credits",Side = "Right"}) do
            ...
            CreditsSection:Label({Text = "Thanks to AlexR32 for Bracket V3"})
            CreditsSection:Label({Text = "Thanks to Ajtan12 for Backround Pictures"})
            CreditsSection:Label({Text = "Thanks to coasts for Modified Universal ESP"})
            CreditsSection:Label({Text = "Thanks to Blissful for Best Offscreen Arrows"})
    ...
    if Weapon and Config then
        ...
        if Ammo.Value > 0 then
            ...
            if (OldAmmo - Ammo.Value) >= 1 then
                RobloxRage.Utilities.UI:Notification2({
...
RobloxRage.Utilities.Misc:FixUpValue(Tortoiseshell.Network.Fire,function(Self,...)
...
RobloxRage.Utilities.Misc:FixUpValue(Tortoiseshell.Projectiles.InitProjectile,function(Self,...)
...
RobloxRage.Utilities.Misc:FixUpValue(Tortoiseshell.Raycast.CastGeometryAndEnemies,function(Self,...)
...
RobloxRage.Utilities.Misc:FixUpValue(Tortoiseshell.Items.GetConfig,function(...)
...
for Index,Event in pairs(Events) do
    if Event.Event == "Votekick" then
        ...
        RobloxRage.Utilities.Misc:FixUpValue(Event.Callback,function(...)
            local Args = {...} if Args[1] == "Message" then
                ...
                and Window.Flags["BadBusiness/AntiKick"] then
                    ...
                    RobloxRage.Utilities.Misc:ReJoin()
                end
            end return ...
        end) break
    end
...
RobloxRage.Utilities.Misc:NewThreadLoop(0,function()
...
RobloxRage.Utilities.Misc:NewThreadLoop(1,function()
    local Weapon,Config = GetEquippedWeapon()
    if Weapon and Config then
