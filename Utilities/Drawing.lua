...
if not HighlightContainer then
    ...
    --RobloxRage.Utilities.Misc:HideObject(HighlightContainer)
...
--[[    return RunService.Heartbeat:Connect(function() local Camera = Workspace.CurrentCamera
        ScreenPosition,OnScreen = Camera:WorldToViewportPoint(Camera,IsBasePart and Item[3].Position or Item[3])
